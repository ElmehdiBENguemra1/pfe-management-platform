...
public class ApplicationService {
    ...
    private ApplicationResponse mapToResponse(Application application) {
        return ApplicationResponse.builder()
                ...
                .studentDepartment(application.getStudent().getStudentProfile() != null ? application.getStudent().getStudentProfile().getDepartment() : null)
                .studentLevel(application.getStudent().getStudentProfile() != null && application.getStudent().getStudentProfile().getLevel() != null ? application.getStudent().getStudentProfile().getLevel().name() : null)
                ...
                .topicCreatedByEmail(application.getTopic().getCreatedBy().getEmail())
                .topicCreatedByPhone(application.getTopic().getCreatedBy().getPhone())
                .topicContactPerson(application.getTopic().getContactPerson())
                .topicCreatorRole(application.getTopic().getCreatedBy().getRole().name())
